...
[快速使用](#快速使用) · [v0.3.2 更新](#v032-更新重点) · [DXM 工作流](#dxm-工作流) · [Trellis 路由](#dxm--trellis) · [生成文件](#生成文件)
...
当前发布版：[`v0.3.2`](https://github.com/mingisrookie/dxm-skill/releases/tag/v0.3.2) · Skill 路径：`skills/dxm` · 核心脚本：`skills/dxm/scripts/scaffold_dxm.py`
