...
[快速使用](#快速使用) · [v1.0.0 更新](#v100-更新重点) · [DXM 工作流](#dxm-工作流) · [Trellis 路由](#dxm--trellis) · [生成文件](#生成文件)
...
当前发布版：[`v1.0.0`](https://github.com/mingisrookie/dxm-skill/releases/tag/v1.0.0) · Skill 路径：`skills/dxm` · 核心脚本：`skills/dxm/scripts/scaffold_dxm.py`
